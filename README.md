...
- Получение данных из Excel файла. Находится в папке attachments. 
(Microsoft.Office.Interop.Excel)


- Вывод на экран (еще не реализован)
    - Написать LINQ для сортировки и группировки паллет ...  
    - Вывод паллет ...

Класс Box1 тестовый он не используется. 

## Послесловие

Не успел доделать, возможно ночью допишу, но уже сейчас можно примерно посмотреть и оценить. Очень надеюсь на обратную связь по тестовому заданию.